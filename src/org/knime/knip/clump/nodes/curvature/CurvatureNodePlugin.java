 ...
 * @author Schlegel
 */
public class CurvatureNodePlugin extends Plugin {
    // The shared instance.
    private static CurvatureNodePlugin plugin;

    /**
     * The constructor.
     */
    public CurvatureNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CurvatureNodePlugin getDefault() {
        return plugin;
    }
