 ...
 * @author Schlegel
 */
public class FourierDescriptorNodePlugin extends Plugin {
    // The shared instance.
    private static FourierDescriptorNodePlugin plugin;

    /**
     * The constructor.
     */
    public FourierDescriptorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FourierDescriptorNodePlugin getDefault() {
        return plugin;
    }
