 ...
 * @author Schlegel
 */
public class FTCurvatureNodePlugin extends Plugin {
    // The shared instance.
    private static FTCurvatureNodePlugin plugin;

    /**
     * The constructor.
     */
    public FTCurvatureNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FTCurvatureNodePlugin getDefault() {
        return plugin;
    }
