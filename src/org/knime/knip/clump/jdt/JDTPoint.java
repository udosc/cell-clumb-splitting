...
public class JDTPoint implements Comparable<JDTPoint>, Serializable {
	 ...
	 */
	public JDTPoint(double x, double y, double z) {
		this.x = x;
		this.y = y;
		this.z = z;
	}
	...
	public JDTPoint(double x, double y) {
		this(x, y, 0);
	}

	/** simple copy constructor */
	public JDTPoint(JDTPoint p) {
		x = p.x;
		y = p.y;
		z = p.z;
	}
	...
	boolean isLess(JDTPoint p) {
		return compareTo(p) < 0;
	}

	boolean isGreater(JDTPoint p) {
		return compareTo(p) > 0;
	}
...
//	public final static int ERROR = 5;
	...
	JDTPoint circumcenter(JDTPoint a, JDTPoint b) {
		...
		return new JDTPoint((u * (b.y - y) - v * (a.y - b.y)) / den, (v * (a.x - b.x) - u * (b.x - x)) / den);
	}
	...
	@Override
	public int compareTo(JDTPoint o) {
		if (o == null)
			return 1;
