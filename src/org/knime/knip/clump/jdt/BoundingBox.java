 ...
 * left and upper right JDTPoint. This is usually used as a rough approximation
...
public class BoundingBox implements Serializable {
	 ...
	 * 
	 * @param lowerLeft
	 *            lower left JDTPoint of the box
	 * @param upperRight
	 *            upper left JDTPoint of the box
	 */
	public BoundingBox(JDTPoint lowerLeft, JDTPoint upperRight) {
	 ...
	 */
	public JDTPoint getMinPoint() {
		return new JDTPoint(minX, minY, minZ);
	}

	/**
	 * @return Minimum coordinate of bounding box
	 */
	public JDTPoint getMaxPoint() {
		return new JDTPoint(maxX, maxY, maxZ);
	}
}